...
def resample_sentiment(source_df, dest_df, sentiment, dateTimeRange, timeDelta):
    """
...
def preprocess(source_df):
    ...
    newDf = resample_sentiment(source_df, newDf, 'polarity_negative', dateTimeRange, dateTimeDelta)
    newDf = resample_sentiment(source_df, newDf, 'polarity_positive', dateTimeRange, dateTimeDelta)
    newDf = resample_sentiment(source_df, newDf, 'polarity_neutral', dateTimeRange, dateTimeDelta)
...
p.line('time', 'polarity_positive', source=newDf, line_color = 'green', legend='Positive Sentiment')
p.line('time', 'polarity_negative', source=newDf, line_color = 'red', legend='Negative Sentiment')
p.line('time', 'polarity_neutral', source=newDf, line_color = 'black')
p.yaxis.axis_label = 'Average Sentiment Polarity'
